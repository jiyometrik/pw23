...
\setmainfont[Microtypography, Ligatures=TeX]{STIX Two Text}
\setmathfont[Microtypography, Ligatures=TeX]{STIX Two Math}
\setmonofont[Microtypography, Ligatures=TeX]{Source Code Pro}
\setsansfont[Microtypography, Ligatures=TeX]{STIX Two Text}
\usepackage{microtype}

\usepackage{siunitx}

\usepackage{scrlayer-scrpage}
\ohead{\small\normalfont GROUP\_NO \\ Sorting sentiments of hotel reviews through machine learning}
...
\usepackage{xcolor}
\definecolor{links}{RGB}{0, 0, 90} % article title; sections
\usepackage{hyperref}
\hypersetup{
	hidelinks,
	colorlinks,
