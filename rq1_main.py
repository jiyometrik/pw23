...
ax_pie_bi.set_title('Proportion of Tokens (Bipartite)')
ax_pie_bi.pie(totals_bi, labels=labels_bi, autopct="%1.1f%%", shadow=False)
plt.savefig("./results/rq1/pie_bipartite.png", dpi=600)

fig_pie_tri, ax_pie_tri = plt.subplots()
ax_pie_tri.set_title('Proportion of Tokens (Tripartite)')
ax_pie_tri.pie(totals_tri, labels=labels_tri, autopct="%1.1f%%", shadow=False)
