\documentclass[12pt, bibliography=totocnumbered, a4paper]{scrartcl}
...
\usepackage{indentfirst} % also tab the first paragraph of each section
...
\usepackage{xcolor}
\definecolor{color1}{RGB}{0, 0, 90} % article title; sections
\definecolor{color2}{RGB}{0, 20, 20} % background boxes
\usepackage{hyperref}
\hypersetup{
	hidelinks,
	colorlinks,
