...
\newmintedfile[pycode]{python}{frame=lines,framesep=2mm,baselinestretch=1.2,fontsize=\small}
\usepackage{tabularx}
...
\usepackage[scale=1.2]{sourcesanspro}
...
\usepackage{setspace}
\usepackage[skip=15pt plus1pt, indent=40pt]{parskip}
\usepackage{hyperref}
